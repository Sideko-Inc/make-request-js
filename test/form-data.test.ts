...
describe('form-data utilities', () => {
  ...
  describe('createForm', () => {
    ...
    it('should handle string values', () => {
      ...
      expect(mockFormData.append).toHaveBeenCalledWith('stringKey', 'string value');
    ...
    it('should handle nested object values', () => {
      ...
      expect(mockFormData.append).toHaveBeenCalledWith('objectKey[nestedKey]', 'nestedValue');
      expect(mockFormData.append).toHaveBeenCalledWith('objectKey[anotherKey]', 'anotherValue');
    });
