...
describe('CoreClient', () => {
  ...
  describe('constructor', () => {
    ...
    it('should create client with object baseUrl', () => {
      ...
      expect(testClient.buildUrl('/path', 'api')).toBe('https://api.test.com/path');
      expect(testClient.buildUrl('/path', 'auth')).toBe('https://auth.test.com/path');
    });
  });
  ...
  describe('buildUrl', () => {
    ...
    it('should handle trailing slash in baseUrl', () => {
      const testClient = new CoreClient({ baseUrl: 'https://api.example.com/' });
      expect(testClient.buildUrl('/users')).toBe('https://api.example.com/users');
    });
  });
  ...
  describe('makeRequest', () => {
    ...
    it('should throw error for invalid form-urlencoded body', async () => {
      ...
      await expect(promise).rejects.toThrow('x-www-form-urlencoded data must be an object at the top level');
    });
